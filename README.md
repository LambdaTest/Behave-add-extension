# Add Browser Extensions in Behave Tests with Selenium on TestMu AI (Formerly LambdaTest)
...
With TestMu AI (Formerly LambdaTest), you can load browser extensions for your Behave automation tests running on a real browser cloud. This sample shows how to configure browser extensions in Behave on the TestMu AI cloud.
...
```bash
git clone https://github.com/LambdaTest/Python-Behave-Selenium.git
...
In the `config.json` file, update the test capabilities and add the extension capability. For example:
